...
#define PROVISION_ATT_HANDLE 	19
#define GATT_PROXY_HANDLE	    (PROVISION_ATT_HANDLE + 9)
extern const u32 ONLINE_ST_ATT_HANDLE_SLAVE;
...
typedef struct{
	u8 conn_mark;
	u8 ext_crystal_en; //struct different from 8258, must be 0
}misc_para_t;
#elif(MCU_CORE_TYPE == MCU_CORE_8258)
typedef struct{
	u8 conn_mark;
