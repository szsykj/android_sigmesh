...
#define ADV_INTERVAL_MS			(80)
#define ADV_INTERVAL_CNT		(ADV_INTERVAL_MS / (ADV_INTERVAL_UNIT * 5 / 8))
...
#else
#define FRI_REC_WIN_MS              (50)    // (0xfa) // (0x32) // if there is many LPN, set longer should be better.
#endif
...
int mesh_rc_data_layer_access(u8 *ac,  int len_ac, u16 adr_src, u16 adr_dst);
...
#define TL_LOG_SEL_VAL	(BIT(TL_LOG_NODE_SDK)|BIT(TL_LOG_FRIEND)|BIT(TL_LOG_IV_UPDATE)) // |BIT(TL_LOG_NODE_SDK_NW_UT)
#endif
