...
int mi_crypto_hkdf_sha256(uint8_t *key, uint8_t key_len, uint8_t *salt, uint8_t salt_len,
                        uint8_t *info, uint16_t info_len, uint8_t *out, uint8_t out_len);
...
int mi_crypto_hmac_sha256(uint8_t *k, uint32_t key_len, uint8_t *p_in, uint32_t in_len, uint8_t *p_out);
