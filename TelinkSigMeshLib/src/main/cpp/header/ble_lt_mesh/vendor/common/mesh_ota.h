...
#else
#define MESH_OTA_UPDATE_NODE_MAX        (4)
#endif
...
#define MESH_OTA_OBJ_SIZE_MAX           (ota_firmware_size_k * 1024)
...
#define NEW_FW_TX_NAME  "new_firmware_tx.bin"
...
u32 new_fw_read(u8 *data_out, u32 max_len,char * p_file_path);
