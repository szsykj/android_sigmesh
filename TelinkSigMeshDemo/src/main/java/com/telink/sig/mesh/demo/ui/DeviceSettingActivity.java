...
public class DeviceSettingActivity extends BaseActivity implements EventListener<String> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        devAddr = deviceInfo.meshAddress;
    ...
    public void performed(Event event) {
        ...
        if (event.getType().equals(NotificationEvent.EVENT_TYPE_GROUP_INFO)) {
            byte[] data = ((NotificationEvent) event).getRawData();

            GroupInfoNotificationParser parser = GroupInfoNotificationParser.create();
            GroupInfoNotificationParser.GroupInfo groupInfo = parser.parse(data);
