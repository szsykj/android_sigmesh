...
//                    startActivity(new Intent(getActivity(), DeviceProvisionActivity.class));
        ...
        mAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                MeshService.getInstance().setOnOff(mDevices.get(position).meshAddress, onOff, !AppSettings.ONLINE_STATUS_ENABLE, !AppSettings.ONLINE_STATUS_ENABLE ? 1 : 0, 1000, (byte) 0, null);
            }
        });
        ...
        mAdapter.setOnItemLongClickListener(new BaseRecyclerViewAdapter.OnItemLongClickListener() {
            ...
            public boolean onLongClick(int position) {
                ...
                intent.putExtra("deviceAddress", mDevices.get(position).meshAddress);
...
//                MeshService.getInstance().cmdOnOff(0xFFFF, (byte) 100, (byte) 1, 1);
                MeshService.getInstance().setOnOff(0xFFFF, (byte) 1, !AppSettings.ONLINE_STATUS_ENABLE, !AppSettings.ONLINE_STATUS_ENABLE ? rspMax : 0, 0, (byte) 0, null);
...
//                MeshService.getInstance().cmdOnOff(0xFFFF, (byte) 100, (byte) 0, 1);
                MeshService.getInstance().setOnOff(0xFFFF, (byte) 0, !AppSettings.ONLINE_STATUS_ENABLE, !AppSettings.ONLINE_STATUS_ENABLE ? rspMax : 0, 0, (byte) 0, null);
                break;
